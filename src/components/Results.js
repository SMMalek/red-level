import React from 'react'
  ...
  const Results = props => {
    ...
    return (
      <div className="flex flex-col m-auto my-7 w-fit">
        <div className="flex flex-col border-2 border-solid rounded-lg border-slate-300">
          <div className="m-auto text-3xl my-8 py-3 px-16">You first answer is <strong className="text-redmenta/90">{check(0)}</strong></div>
          <hr className="border-slate-200 border-solid mx-4"/>
          <div className="m-auto text-3xl my-8 my-8 py-3 px-16 ">You second answer is <strong className="text-redmenta/90">{check(1)}</strong></div>
          <hr className="border-slate-200 border-solid mx-4"/>
          <div className="m-auto text-3xl my-8 my-8 py-3 px-16">You third answer is <strong className="text-redmenta/90">{check(2)}</strong></div>
        </div>
